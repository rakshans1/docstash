          ...
          <div className="container-fluid library">
            ...
            <div className="row">
              ...
              <div className="col-md-2 col-xs-6 folder-div">
                <a href=""><div className="folder">
                  <p className="foldername"><i className="flaticon flaticon-folder"></i>Folder1</p>
                </div></a>
              </div>
              <div className="col-md-2 col-xs-6 folder-div">
                <a href=""><div className="folder">
            ...
            <div className="row">
              ...
              <div className="col-md-2 col-xs-6 image-div">
                ...
                <p className="filename"><i className="flaticon-file flaticon-photo"></i> Image1.jpg</p>
              ...
              <div className="col-md-2 col-xs-6 doc-div">
                ...
                <p className="filename"><i className="flaticon-file flaticon-interface"></i> Document1.doc</p>
                <p className="filetime">2 hours ago</p>
              </div>
              ...
              <div className="col-md-2 col-xs-6 doc-div">
                ...
                <p className="filename"><i className="flaticon-file flaticon-interface"></i> Document1.pdf</p>
                <p className="filetime">2 hours ago</p>
              </div>
              <div className="col-md-2 col-xs-6 doc-div">
                <div className="image-wrapper">
                ...
                <p className="filename"><i className="flaticon-file flaticon-multimedia"></i> Video.avi</p>
                <p className="filetime">2 hours ago</p>
              </div>
              <div className="col-md-2 col-xs-6 doc-div">
                <div className="image-wrapper">
                ...
                <p className="filename"><i className="flaticon-file flaticon-interface"></i> setup.exe</p>
                <p className="filetime">2 hours ago</p>
              </div>
              <div className="col-md-2 col-xs-6 doc-div">
                <div className="image-wrapper">
                ...
                <p className="filename"><i className="flaticon-file flaticon-interface"></i> Game.iso</p>
                <p className="filetime">2 hours ago</p>
              </div>
              <div className="col-md-2 col-xs-6 doc-div">
                <div className="image-wrapper">
                ...
                <p className="filename"><i className="flaticon-file flaticon-interface"></i> index.html</p>
                <p className="filetime">2 hours ago</p>
              </div>
              <div className="col-md-2 col-xs-6 doc-div">
                <div className="image-wrapper">
                ...
                <p className="filename"><i className="flaticon-file flaticon-interface"></i> main.css</p>
                <p className="filetime">2 hours ago</p>
              </div>
