...
class PasswordValidator extends React.Component {
  ...
  let forbiddenWords = this.state.forbiddenWords.map((word, i) => {
    return (
...
PasswordValidator.propTypes = {
  forbiddenWords: PropTypes.array.isRequired,
  minCharacters: PropTypes.string.isRequired,
  requireCapitals: PropTypes.string.isRequired,
  requireNumbers: PropTypes.string.isRequired,
  name: PropTypes.string.isRequired,
  visible: PropTypes.bool.isRequired,
  validData: PropTypes.object.isRequired,
