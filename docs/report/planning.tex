...
\begin{figure}[h]
\begin{center}
    \psfig{figure=./img/gantt1.png,height=2.3in}
    \caption{Project schedule-1}
    \label{1}
\end{center}
\end{figure}
\begin{figure}[h]
\begin{center}
    \psfig{figure=./img/gantt2.png,height=2.3in}
    \caption{Project schedule-2}
    \label{1}
\end{center}
\end{figure}
\begin{figure}[h]
\begin{center}
    \psfig{figure=./img/gantt3.png,height=2.3in}
