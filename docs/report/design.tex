...
% \begin{figure}[h]
%   \begin{center}
%   \psfig{figure=./dfd.png,width=6in,height=4.5in}
%     \caption{DFD –level 0 for Society Scoop Application }
%     \label{7}
%     \end{center}
%     \end{figure}
...
% \begin{figure}[h]
%     \begin{center}
%   \psfig{figure=./dfd2.eps,width=6in,height=4.5in}
%     \caption{DFD –level 1 for Society Scoop Application }
%     \label{8}
%     \end{center}
%     \end{figure}
...
%     \begin{center}
%   \psfig{figure=./dfd2.eps,width=6in,height=4.5in}
%     \caption{DFD –level 2 for Society Scoop Application }
%     \label{9}
%     \end{center}
%     \end{figure}
